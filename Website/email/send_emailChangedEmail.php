<?php
	...
	$mail -> CharSet = "UTF-8";
	$mail->Subject = "Password changed on The Horde";						//Assunto do email
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="20" background="http://aluno14738.damiaodegoes.pt/img/bg.png" style="background-repeat: no-repeat; background-position: top center; background-size: cover;">
		<tr>
			<td>
				...
				<p style="font-size: 1.5em; color: white">We want to notice you that your email was changed on our website and so will no longer be used to connect to your account. <br> If you changed it you can ignore this email safely, otherwise we hardly encourage you to verify your account.</p>
				<hr style="background-color: orange; height: 7px; border-color: black;">
	...
	if(!$mail->send()) {
		...
		header("Location: http://aluno14738.damiaodegoes.pt/profile/profile.php?page=security&emC=1");
	}
