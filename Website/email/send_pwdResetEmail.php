<?php
	...
	$mail->addAddress($_SESSION["resetEmail"], 'The Horde');	//Adicionar um destinatário
	...
	$mail -> CharSet = "UTF-8";
	$mail->Subject = "Password Reset on The Horde";						//Assunto do email
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="20" background="http://aluno14738.damiaodegoes.pt/img/bg.png" style="background-repeat: no-repeat; background-position: top center; background-size: cover;">
		<tr>
			<td>
				...
				<p style="font-size: 1.5em; color: white">We are sad to hear that you are having trouble with your account! But we are here to help you.<br> Use this password to login and change it!<br><br>Temporary Password: '. $_SESSION["tempPwd"] .'</p>
				<hr style="background-color: orange; height: 7px; border-color: black;">
